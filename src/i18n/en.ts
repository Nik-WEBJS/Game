export const en = {
  ...
  // Tips
  wikiTip1: 'Minimum viable start: Developer + Marketing. With only 1 Developer you are usually cash-negative (debt is allowed until -$500,000).',
  wikiTip2: 'Do not overhire before stable Release and first audience traction: fixed costs burn cash fast, and debt is not a long-term strategy.',
